  ...
  return (
    <header className="flex items-center justify-between px-6 sm:px-10 py-5 bg-white/80 backdrop-blur-md border-b border-gray-100/50 sticky top-0 z-50">
      <div className="flex items-center gap-4">
        ...
        >
          <img src="/logo.svg" alt="Logo" className="w-32 h-22 pt-2" />
        </Link>
      </div>
      ...
      <div className="flex items-center gap-4">
        <div className="relative">
          <Link
            to="/cart"
            className="bg-theme-bg text-theme-brand px-5 py-2.5 rounded-full font-medium flex items-center gap-2 hover:bg-theme-light-pink transition-colors"
          >
